...
def login(page):
    ...
    username = "muralimohan.pagadala@serole.com"
...
def manager_approval(manager_page):
    manager_page.get_by_role("textbox", name="Username or email").fill("venkatesh.soodula@gmail.com")
...
def renewal(page):
    ...
    page.get_by_text("New Renewal", exact=True).first.click()
    page.locator("p.subbody.m-0").filter(has_text="New Renewal").first.click()
